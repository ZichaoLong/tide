...
| S5.1 | unified smoke/non-smoke entry and fixed suite below; explicit nograd-forward/grad-forward/backward/optimizer/train-step implementations and bounds | unified graph runner implemented;127 directed runner/CLI tests passed; [entry/modes](foundation-benchmarks.md); LH/PDG portable kit remains inference-only |
