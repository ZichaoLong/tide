...
| S5.2 | three graph families measured; both large shape presets counted and evaluated under resource preflight, timeout and process reaping; report achieved size and failures | all108 medium runs completed; [medium evidence](evidence/foundation-medium.md); wide PDG/LH and narrow failure retained; new bounded DAG/Settle large evaluation running |
