...
| M5 | Packed attention/GQA/window, linear attention, DeltaRule, SSM, FFN/SwiGLU; step/block equivalence; source-aware Agg and HARD/HST/SOFTP Emit | state interface + SSM/SwiGLU verified; [evidence](evidence/m5a-state-programs.md); attention/linear/Delta pending |
