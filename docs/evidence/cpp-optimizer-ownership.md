...
Clean source: `9aef27aa2e8eeeda6f3d6298ae295bf687b3a66b` (`9aef27a`). The
...
The durable unit
`tide-foundation-named-optimizer-qualified-20260922-1045` ran in
`background.slice` with Nice=10. Its terminal record is
`artifacts/named-optimizer-qualified-20260922-1045/status.json`, and its
independent build is `/var/tmp/zlong-graph-execution-foundation/qualification/named-optimizer-build-9aef27a`.

```sh
build=/var/tmp/zlong-graph-execution-foundation/qualification/named-optimizer-build-9aef27a
...
passed **338 tests in 63.13 seconds**. It compares native LibTorch SGD and
